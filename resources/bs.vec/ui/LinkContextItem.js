 ...
 * Backported changes: complete class definition
 */
...
ve.ui.LinkContextItem.prototype.updateLabelPreview = function () {
	var annotationView = this.getAnnotationView(),
		// Note: in the backported original, $element is used instead of $anchor
		label = annotationView && annotationView.$anchor[ 0 ].innerText.trim();
...
ve.ui.LinkContextItem.prototype.onLabelButtonClick = function () {
	...
	// Note: in the backported original, $element is used instead of $anchor
	surface.selectNodeContents( annotationView.$anchor[ 0 ] );
};
